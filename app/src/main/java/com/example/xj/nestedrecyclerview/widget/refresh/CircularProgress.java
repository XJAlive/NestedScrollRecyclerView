...
public class CircularProgress extends View {
    ...
    public CircularProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mCircularColor = a.getColor(R.styleable.CircularProgress_circularColor,
                ContextCompat.getColor(context, R.color.pink));
        a.recycle();
       /* mColors = new int[4];
        mColors[0] = context.getResources().getColor(mCircularColor);
        mColors[1] = context.getResources().getColor(R.color.ma_home_bar_color);
        mColors[2] = context.getResources().getColor(R.color.ma_home_bar_color);
        mColors[3] = context.getResources().getColor(R.color.ma_home_bar_color);*/
    ...
    public void draw(Canvas canvas) {
        ...
        if (mModeAppearing) {
            mPaint.setColor(gradient(mCircularColor, mCircularColor,
