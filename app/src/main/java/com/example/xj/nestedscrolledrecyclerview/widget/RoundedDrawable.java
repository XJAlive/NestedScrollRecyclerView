package com.example.xj.nestedscrolledrecyclerview.widget;
...
public class RoundedDrawable extends Drawable {
  ...
  public static Bitmap drawableToBitmap(Drawable drawable) {
    return drawableToBitmap(drawable, 2);
  }

  private static Bitmap drawableToBitmap(Drawable drawable, int retryCount) {
    ...
    try {
      ...
      System.gc();
      if (retryCount > 0) {
        bitmap = drawableToBitmap(drawable, --retryCount);
      } else {
        bitmap = null;
      }
    }
